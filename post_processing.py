...
@click.option('-d', '--data', help='prediction data path',
              type=click.Path(exists=True, dir_okay=True, resolve_path=True), default='out_good',required=True)
@click.option('-o', '--output', help='output path',
              type=click.Path(dir_okay=True, resolve_path=True), default='out_good_proc',required=True)
